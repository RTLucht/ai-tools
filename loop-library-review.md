...
| Date | Change |
|---|---|
| 2026-09-21 | Sync attempted — eleventh consecutive week blocked. signals.forwardfuture.ai returns EGRESS_BLOCKED via proxy; domain is not on the allowlist. No new entries added. Proxy allowlist update required to resume syncs. |
| 2026-09-14 | Sync attempted — tenth consecutive week blocked. signals.forwardfuture.ai returns EGRESS_BLOCKED via proxy; domain is not on the allowlist. No new entries added. Proxy allowlist update required to resume syncs. |
| 2026-09-07 | Sync attempted — ninth consecutive week blocked. signals.forwardfuture.ai returns EGRESS_BLOCKED via proxy; domain is not on the allowlist. No new entries added. Proxy allowlist update required to resume syncs. |
| 2026-08-31 | Sync attempted — eighth consecutive week blocked. signals.forwardfuture.ai returns EGRESS_BLOCKED via proxy; domain is not on the allowlist. No new entries added. Proxy allowlist update required to resume syncs. |
